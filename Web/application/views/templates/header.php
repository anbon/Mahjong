...
<!--   <link href="<?php echo base_url();?>assets/css/theme/avocado.css" rel="stylesheet" type="text/css" id="theme-style"> -->
  ...
  <script type="text/javascript">
  	...
  	var thisBaseUrl = "<?php echo base_url();?>";

  	var memberconf = function (count){
		if (confirm("確認要刪除這筆資料?") == true) {
			document.location.href='<?php echo base_url(); ?>index.php/delete/'+count;
		}else{
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="breadcrumb clearfix">
			...
			<div class="container">
				...
				<ul class="pull-left">
					<li><a href="index.html"><i class="icon-home"></i> Home</a> <span class="divider">/</span></li>
					<li><a href="#"><i class="icon-th-large"></i> Components</a> <span class="divider">/</span></li>
					<li class="active"><a href="#"><i class="icon-table"></i> Tables</a></li>
				</ul>
				<!-- / Top Fixed Bar: Breadcrumb Location -->
		...
		<div class="navbar navbar-inverse" id="nav">
			...
			<div class="navbar-inner">
				...
				<ul class="nav">
					...
					<li><a href="index.html"><i class="icon-align-justify"></i> Dashboard</a></li>
					<!-- / Main Navigation: Dashboard -->
					...
					<li class="dropdown active">
							...
							<ul class="dropdown-menu">
								...
								<li class="active"><a href="tables.html"><i class="icon-table"></i> Tables</a></li>
